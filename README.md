...
5. Алгоритм перебора переменных массива Q = N\P гарантированно находит решение 3SAT выражения. Сложность O(2^|Q|)
6. Максимальная сложность разложения O(2^(min(|P|,|Q|)), |P|+|Q|=n
