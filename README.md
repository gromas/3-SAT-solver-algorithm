...
Если вы уже читаете это, можете дальше не читать. Сразу идите по ссылке - там в простой форме обьяснена суть и конечная фаза развития алгоритма распространения через контекст BDD и доказательство его полиномиальной сложности на границе фазового перехода (m/n~4.267). 
