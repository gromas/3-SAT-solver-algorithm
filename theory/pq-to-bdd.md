...
После обработки всех переменных из P остаётся **единственный BDD**, зависящий только от переменных Q. Этот BDD представляет собой точную проекцию исходной формулы на подпространство Q.
